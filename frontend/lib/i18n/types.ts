export interface Translations {
  ...
  beef: {
    ...
    tldrLabel: string
    tldrPlaceholder: string
    durationLabel: string
    chatEvidenceLabel: string
    chatEvidenceNoOpponent: string
    noChat: string
    ...
    submit: string
    submitHint: string
    coinPurchaseError: string
    createError: string
    // Detail page
    roleInitiator: string
    roleTarget: string
    chatPassageSection: string
    totalLabel: string
    votesLabel: string
    doubleKo: string
    doubleKoDesc: string
    ...
    winsThisBeef: string
    noWinnerDesc: string
    coinDistribution: string
    betters: string
    potTotal: string
    closesIn: string
    // GameOverlay
    waitingForPlayers: string
    spectatorWait: string
    potLabel: string
    potDistributionDesc: string
    readyBtn: string
    waitingBtn: string
    ...
    // RPS
    roundLabel: string
    rpsDrawNewRound: string
    rpsYouWinRound: string
    rpsWinsRound: string
    rpsChoose: string
    rpsWaiting: string
    rpsBothChosen: string
    rpsOpponentChose: string
    rpsRock: string
    rpsPaper: string
    rpsScissors: string
    rpsLizard: string
    ...
    tttBestOf3: string
    tttWinsBeef: string
    tttDrawRepeat: string
    tttWinsRound: string
    tttNextRound: string
    tttDrawExtra: string
    tttMyTurn: string
    tttTheirTurn: string
    tttSecondsToMove: string
    tttTimeLeft: string
    // Mastermind
    mmSolved: string
    mmAttempt: string
    ...
    mmClear: string
    mmGuess: string
    mmBothGuessing: string
    // Game option picker descriptions
    rpsGameDesc: string
    tttGameDesc: string
    mmGameDesc: string
    reactionGameDesc: string
    // Reaction
    reactionTitle: string
    reactionWait: string
    reactionGo: string
    reactionCalculating: string
    reactionDone: string
