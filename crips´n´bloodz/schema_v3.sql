-- ============================================================
--  PAARSHIP – Datenbankschema v3
--  PostgreSQL 16 + PostGIS 3.4
--  DSGVO-konform | AES-256 (pgcrypto) | bcrypt | SHA-256+Salt
--  DB-Level: Triggers, Constraints, Regex-Checks
-- ============================================================
-- Ausführen:
--   docker exec -i paarship_db psql -U paarship_user -d paarship < schema_v3.sql
-- ============================================================
...
BEGIN
  SELECT (c.accepted = true AND a.type = 'sensitive_data')
  INTO consent_valid
  FROM consent_logs c
...
INSERT INTO users (
    ...
    'admin', 'standard', true,
    'system-deleted-user-placeholder-000000000000000000000000000',
    'system-no-login'
);
...
CREATE TABLE contact_requests (
    ...
    CONSTRAINT uq_contact_request UNIQUE (sender_id, receiver_id),
